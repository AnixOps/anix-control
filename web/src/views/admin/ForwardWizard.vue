<template>
  <div class="wizard-page">
    ...
    <a-steps :current="stepIndex" class="wizard-steps">
      <a-step :title="t('forwardWizard.steps.mode.title')" />
      <a-step :title="t('forwardWizard.steps.machine.title')" />
      <a-step :title="t('forwardWizard.steps.tunnel.title')" />
      <a-step :title="t('forwardWizard.steps.forward.title')" />
      <a-step :title="t('forwardWizard.steps.done.title')" />
    </a-steps>
