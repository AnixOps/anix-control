...
- Current preview: `v4.0.0-alpha.3` (official signed packages and actor-scoped
  WebUI plugin management are usable in this alpha).
...
`v4.0.0`, `v4.0.0-alpha.3`, `v4.0.0-beta.1`, and `v4.0.0-rc.1`. Tag builds
produce:
