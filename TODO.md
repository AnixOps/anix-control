...
Current scope: panel peer custody, native WireGuard subscription output, sing-box WireGuard outbound output, and unit coverage are implemented. V2bX runtime, admin UI, traffic/online/limit behavior, migration dry-run evidence, and GitHub Actions relay-path verification are still pending.
