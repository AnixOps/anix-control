#!/usr/bin/env python3
"""Build and verify the deterministic nftables Forward combined package."""
...
def run_self_test() -> None:
    with tempfile.TemporaryDirectory() as temporary_root:
        ...
        agent_path = root / "nftables-forward-agent"
    ...
    print("nftables-forward package self-test passed")
