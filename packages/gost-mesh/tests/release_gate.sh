#!/usr/bin/env bash
# Execute the official GOST Mesh package release contract without
...
usage() {
  cat <<'EOF'
Usage: packages/gost-mesh/tests/release_gate.sh [--help]
