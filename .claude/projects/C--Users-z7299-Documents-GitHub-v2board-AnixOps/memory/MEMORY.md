...
- 测试工具目录: `internal/tests/testutil/`
- E2E 测试目录: `internal/tests/e2e/`
...
make test-coverage-html # 生成 HTML 报告
```
...
- `internal/grpc/node_server.go` - gRPC 服务端实现
...
- `internal/tests/e2e/*.go` - E2E 测试套件
