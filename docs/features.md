...
| Admin | Subscription groups, templates, preview, user/plan binding | Implemented | `/api/v2/admin/subscription/*`, unified group/template CRUD success/user-error envelopes | Keep public subscription compatibility separate. |
