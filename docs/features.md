...
| Admin | Subscription groups, templates, preview, user/plan binding | Implemented | `/api/v2/admin/subscription/*`, unified group/template CRUD, protocol-binding, and preview success/user-error envelopes | Keep public subscription compatibility separate. |
