...
| User | User notification inbox | Implemented | `/api/v2/user/notifications*` | Add broader event coverage as business events grow. |
...
| Admin | System config and audit logs | Implemented | `/api/v2/admin/system/configs*`, `/audit-logs` | Keep sensitive config masking tests current. |
