...
- Release binaries and frontend assets must be produced by GitHub Actions; the local source-tree deploy script is guarded and not an approved release build path.
